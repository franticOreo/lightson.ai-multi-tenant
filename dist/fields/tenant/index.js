...
exports.tenant = {
    ...
    access: {
        ...
        read: tenantAdmins_1.tenantAdminFieldAccess,
    ...
    hooks: {
        ...
        beforeChange: [
            function (_a) {
                var req = _a.req, user = _a.req.user, data = _a.data;
                return __awaiter(void 0, void 0, void 0, function () {
                    var _b;
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            case 0: return [4 /*yield*/, (0, isSuperAdmin_1.isSuperAdmin)(req.user)];
                            case 1:
                                if ((_c.sent()) && (data === null || data === void 0 ? void 0 : data.tenant)) {
                                    return [2 /*return*/, data.tenant];
                                }
                                if ((_b = user === null || user === void 0 ? void 0 : user.lastLoggedInTenant) === null || _b === void 0 ? void 0 : _b.id) {
                                    return [2 /*return*/, user.lastLoggedInTenant.id];
                                }
